...
namespace ModernUIWithCaliburnMicro.ViewModels
{
    ...
    public class SettingsAppearanceViewModel : PropertyChangedBase
    {
        ...
        {
            get { return _selectedPalette == PaletteMetro ? this.metroAccentColors : this.wpAccentColors; }
        }

        protected string _selectedPalette = PaletteWP;
        public string SelectedPalette
        {
            get { return _selectedPalette; }
            set
            {
                if (_selectedPalette == value) return;
        ...
        protected string _selectedFontSize;
        ...
        protected Color _selectedAccentColor;
